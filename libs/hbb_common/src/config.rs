...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("RealControl".to_owned());
...
pub const LINK_DOCS_HOME: &str = "https://realcontrol.com/docs/en/";
pub const LINK_DOCS_X11_REQUIRED: &str = "https://realcontrol.com/docs/en/manual/linux/#x11-required";
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rs-ny.realcontrol.com"];
