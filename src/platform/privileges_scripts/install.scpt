on run {daemon_file, agent_file, user}
  ...
  set sh3 to "cp -rf /Users/" & user & "/Library/Preferences/com.carriez.RealControl/RealControl.toml /var/root/Library/Preferences/com.carriez.RealControl/;"

  set sh4 to "cp -rf /Users/" & user & "/Library/Preferences/com.carriez.RealControl/RustDesk2.toml /var/root/Library/Preferences/com.carriez.RealControl/;"

  set sh5 to "launchctl load -w /Library/LaunchDaemons/com.carriez.RustDesk_service.plist;"

  set sh to sh1 & sh2 & sh3 & sh4 & sh5

  do shell script sh with prompt "RealControl want to install daemon and agent" with administrator privileges
end run
