...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the RealControl network..."),
        ...
        ("install_tip", "Due to UAC, RealControl can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install RealControl to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant RealControl \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant RealControl \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow RealControl to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [RealControl Input] service."),
        ...
        ("doc_mac_permission", "https://realcontrol.com/docs/en/client/mac/#enable-permissions"),
        ("Ignore Battery Optimizations", "Ignore battery optimizations"),
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next RealControl application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant RealControl \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant RealControl \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running RealControl."),
        ...
        ("verify_rustdesk_password_tip", "Verify RealControl password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use RealControl and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Please upgrade RealControl Server Pro to version {} or newer!"),
        ("pull_group_failed_tip", "Failed to refresh group"),
        ("doc_fix_wayland", "https://realcontrol.com/docs/en/client/linux/#x11-required"),
        ("display_is_plugged_out_msg", "The display is plugged out, switch to the first display."),
        ("selinux_tip", "SELinux is enabled on your device, which may prevent RealControl from running properly as controlled side."),
        ...
        ("powered_by_me", "Powered by RealControl"),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if RealControl window is open"),
