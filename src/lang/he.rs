...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", ""),
        ("Established", ""),
        ("connecting_status", "מתחבר לרשת RealControl..."),
        ("Enable service", ""),
        ("Start service", ""),
        ("Service is running", ""),
        ...
        ("install_tip", "בגלל UAC, RealControl לא יכול לפעול כראוי כצד מרוחק בחלק מהמקרים. כדי להימנע מ-UAC, אנא לחץ על הכפתור למטה כדי להתקין את RealControl במערכת."),
        ("Click to upgrade", ""),
        ("Click to download", ""),
        ("Click to update", ""),
        ("Configure", ""),
        ("config_acc", "כדי לשלוט מרחוק בשולחן העבודה שלך, עליך להעניק ל-RealControl הרשאות \"נגישות\"."),
        ("config_screen", "כדי לגשת מרחוק לשולחן העבודה שלך, עליך להעניק ל-RealControl הרשאות \"הקלטת מסך\"."),
        ("Installing ...", ""),
        ("Install", ""),
        ("Installation", ""),
        ...
        ("android_input_permission_tip1", "כדי שמכשיר מרוחק יוכל לשלוט במכשיר האנדרואיד שלך באמצעות עכבר או מגע, עליך לאפשר ל-RealControl להשתמש בשירות \"נגישות\"."),
        ("android_input_permission_tip2", "אנא עבור לדף ההגדרות של המערכת הבא, מצא והכנס ל[שירותים מותקנים], הפעל את שירות [RealControl Input]."),
        ...
        ("android_open_battery_optimizations_tip", "אם ברצונך לבטל תכונה זו, אנא עבור לדף ההגדרות של יישום RealControl הבא, מצא והכנס ל[סוללה], הסר את הסימון מ-[לא מוגבל]"),
        ("Start on boot", ""),
        ...
        ("config_input", "כדי לשלוט בשולחן העבודה המרוחק באמצעות מקלדת, עליך להעניק ל-RealControl הרשאות \"מעקב אחרי קלט\"."),
        ("config_microphone", "כדי לדבר מרחוק, עליך להעניק ל-RealControl הרשאות \"הקלטת שמע\"."),
        ...
        ("still_click_uac_tip", "עדיין דורש מהמשתמש המרוחק ללחוץ OK בחלון ה-UAC של הרצת RealControl."),
        ...
        ("verify_rustdesk_password_tip", "אמת סיסמת RealControl"),
        ...
        ("scam_text1", "אם אתה בשיחת טלפון עם מישהו שאינך מכיר ואינך סומך עליו שביקש ממך להשתמש ב-RealControl ולהתחיל את השירות, אל תמשיך ונתק מיד."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "אנא שדרג את RealControl Server Pro לגרסה {} או חדשה יותר!"),
        ...
        ("selinux_tip", "SELinux מופעל במכשיר שלך, מה שעלול למנוע מ-RealControl לפעול כראוי כצד הנשלט."),
        ("Change view", ""),
        ("Big tiles", ""),
        ("Small tiles", ""),
        ("List", ""),
