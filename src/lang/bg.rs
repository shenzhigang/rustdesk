...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Свързване с RealControl мрежата..."),
        ...
        ("install_tip", "Поради UAC, RealControl в някои случай не може да работи правилно като отдалечена достъп. За да заобиколите UAC, моля, щракнете върху бутона по-долу, за да инсталирате RealControl в системата."),
        ...
        ("config_acc", "За да управлявате вашия работен плот дистанционно, трябва да предоставите на RealControl разрешения \"Достъпност\"."),
        ...
        ("android_input_permission_tip1", "За да може отдалечено устройство да управлява вашето Android устройство чрез мишка или докосване, трябва да разрешите на RealControl да използва услугата \"Достъпност\"."),
        ("android_input_permission_tip2", "Моля, отидете на следващата страница с системни настройки, намерете и въведете [Installed Services], включете услугата [RealControl Input]."),
        ...
        ("Turned off", ""),
        ("Language", "Език"),
        ("Keep RealControl background service", ""),
        ("Ignore Battery Optimizations", "Игнорирай оптимизациите на батерията"),
        ("android_open_battery_optimizations_tip", "Ако искате да деактивирате тази функция, моля, отидете на следващата страница с настройки на приложението RealControl, намерете и въведете [Battery], премахнете отметката от [Unrestricted]"),
        ...
        ("Show RealControl", "Покажи RealControl"),
        ...
        ("config_input", "За да контролирате отдалечен работен плот с клавиатура, трябва да предоставите на RealControl разрешения \"Input Monitoring\"."),
        ("config_microphone", "За да говорите дистанционно, трябва да предоставите на RealControl разрешения \"Запис на звук\"."),
        ...
        ("still_click_uac_tip", "Все още изисква отдалеченият потребител да щракне върху OK в прозореца на UAC при стартиранят RealControl."),
        ...
        ("verify_rustdesk_password_tip", "Проверете RealControl паролата"),
        ...
        ("scam_text1", "Ако разговаряте по телефона с някой, когото НЕ ПОЗНАВАТЕ и НЯМАТЕ ДОВЕРИЕ, който ви е помолил да използвате RealControl и да стартирате услугата, не продължавайте и затворете незабавно."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Моля обновете RealControl Server Pro на версия {} или по-нова!"),
        ...
        ("selinux_tip", "SELinux е активиран на вашето устройство, което може да попречи на RealControl да работи правилно като контролирана страна."),
        ("Change view", ""),
        ("Big tiles", ""),
        ("Small tiles", ""),
        ("List", ""),
