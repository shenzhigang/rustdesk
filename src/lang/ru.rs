...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Подключение к сети RealControl..."),
        ...
        ("install_tip", "В некоторых случаях из-за UAC RealControl может работать неправильно на удалённом узле. Чтобы избежать возможных проблем с UAC, нажмите кнопку ниже для установки RealControl в системе."),
        ("Click to upgrade", "Нажмите, чтобы обновить"),
        ("Click to download", "Нажмите, чтобы загрузить"),
        ("Click to update", "Нажмите, чтобы обновить"),
        ("Configure", "Настроить"),
        ("config_acc", "Чтобы удалённо управлять своим рабочим столом, вы должны предоставить RealControl права \"доступа\""),
        ("config_screen", "Для удалённого доступа к рабочему столу вы должны предоставить RealControl права \"снимок экрана\""),
        ...
        ("android_input_permission_tip1", "Чтобы удалённое устройство могло управлять вашим Android-устройством с помощью мыши или нажатий, необходимо разрешить RealControl использовать службу \"Специальные возможности\"."),
        ("android_input_permission_tip2", "Перейдите на соответствующую страницу системных настроек, найдите и войдите в \"Установленные службы\", включите службу \"RealControl Input\"."),
        ...
        ("Turned off", "Отключён"),
        ("Language", "Язык"),
        ("Keep RealControl background service", "Держать в фоне службу RealControl"),
        ...
        ("Show RealControl", "Показать RealControl"),
        ...
        ("config_input", "Чтобы управлять удалённым рабочим столом с помощью клавиатуры, необходимо предоставить RealControl разрешения \"Мониторинг ввода\"."),
        ("config_microphone", "Чтобы разговаривать с удалённой стороной, необходимо предоставить RealControl разрешение \"Запись аудио\"."),
        ...
        ("still_click_uac_tip", "По-прежнему требуется, чтобы удалённый пользователь нажал \"OK\" в окне UAC при запуске RealControl."),
        ...
        ("verify_rustdesk_password_tip", "Подтвердить пароль RealControl"),
        ...
        ("scam_text1", "Если вы разговариваете по телефону с кем-то, кого вы НЕ ЗНАЕТЕ и НЕ ДОВЕРЯЕТЕ, и он просит вас использовать RealControl и запустить его службу, не продолжайте и немедленно прервите разговор."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Обновите RealControl Server Pro до версии {} или новее!"),
        ...
        ("selinux_tip", "На вашем устройстве включён SELinux, что может помешать правильной работе RealControl на контролируемой стороне."),
        ("Change view", "Вид"),
        ...
        ("powered_by_me", "Основано на RealControl"),
        ...
        ("allow-only-conn-window-open-tip", "Разрешать подключение только при открытом окне RealControl"),
        ...
        ("floating_window_tip", "Помогает поддерживать фоновую службу RealControl"),
        ...
        ("About RealControl", "О RealControl"),
