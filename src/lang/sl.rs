...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Vzpostavljanje povezave z omrežjem RealControl..."),
        ...
        ("install_tip", "Zaradi nadzora uporabniškega računa, RealControl v nekaterih primerih na oddaljeni strani ne deluje pravilno. Temu se lahko izognete z namestitvijo."),
        ...
        ("android_input_permission_tip2", "Pojdite v sistemske nastavitve, poiščite »Nameščene storitve« in vklopite storitev »RealControl Input«."),
        ...
        ("Language", "Jezik"),
        ("Keep RealControl background service", "Ohrani RustDeskovo storitev v ozadju"),
        ("Ignore Battery Optimizations", "Prezri optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Če želite izklopiti to možnost, pojdite v nastavitve aplikacije RealControl, poiščite »Baterija« in izklopite »Neomejeno«"),
        ("Start on boot", ""),
