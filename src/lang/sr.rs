...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Zbog UAC RealControl ne može raditi pravilno u nekim slučajevima. Da biste prevazišli UAC, kliknite taster ispod da instalirate RealControl na sistem."),
        ...
        ("config_acc", "Da biste daljinski kontrolisali radnu površinu, RealControl-u treba da dodelite \"Accessibility\" prava."),
        ("config_screen", "Da biste daljinski pristupili radnoj površini, RealControl-u treba da dodelite \"Screen Recording\" prava."),
        ...
        ("android_input_permission_tip1", "Da bi daljinski uređaj kontrolisao vaš Android uređaj preko miša ili na dodir, treba da dozvolite RealControl-u da koristi \"Accessibility\" servis."),
        ("android_input_permission_tip2", "Molimo pređite na sledeću stranicu sistemskih podešavanja, pronađite i unesite [Installed Services], uključite [RealControl Input] servis."),
        ...
        ("android_open_battery_optimizations_tip", "Ako želite da onemogućite ovu funkciju, molimo idite na sledeću stranicu za podešavanje RealControl aplikacije, pronađite i uđite u [Battery], isključite [Unrestricted]"),
        ("Start on boot", ""),
        ...
        ("Show RealControl", "Prikazi RealControl"),
        ("This PC", "Ovaj PC"),
        ("or", "ili"),
