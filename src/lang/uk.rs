...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Підключення до мережі RealControl..."),
        ...
        ("install_tip", "Через UAC, в деяких випадках RealControl може працювати некоректно на віддаленому вузлі. Щоб уникнути UAC, натисніть кнопку нижче для встановлення RealControl в системі"),
        ...
        ("config_acc", "Для віддаленого керування вашою стільницею, вам необхідно надати RealControl дозволи \"Спеціальні можливості\""),
        ("config_screen", "Для віддаленого доступу до вашої стільниці, вам необхідно надати RealControl дозволи на \"Запис екрана\""),
        ...
        ("android_input_permission_tip1", "Для того, щоб віддалений пристрій міг керувати вашим Android-пристроєм за допомогою миші або дотику, вам необхідно дозволити RealControl використовувати службу \"Спеціальні можливості\"."),
        ("android_input_permission_tip2", "Будь ласка, перейдіть на наступну сторінку системних налаштувань, знайдіть та увійдіть у [Встановлені служби], увімкніть службу [RealControl Input]."),
        ...
        ("Language", "Мова"),
        ("Keep RealControl background service", "Зберегти фонову службу RealControl"),
        ...
        ("Show RealControl", "Показати RealControl"),
        ("This PC", "Цей ПК"),
        ("or", "чи"),
        ...
        ("config_input", "Для віддаленого керування віддаленою стільницею з клавіатури, вам необхідно надати RealControl дозволи на \"Відстеження введення\""),
        ("config_microphone", "Для можливості віддаленої розмови, вам необхідно надати RealControl дозвіл на \"Запис аудіо\""),
        ...
        ("verify_rustdesk_password_tip", "Перевірте пароль RealControl"),
        ...
        ("scam_text1", "Якщо ви розмовляєте по телефону з кимось, кого НЕ ЗНАЄТЕ чи кому НЕ ДОВІРЯЄТЕ, і ця особа хоче, щоб ви використали RealControl та запустили службу, не робіть цього та негайно завершіть дзвінок."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Будь ласка, оновіть RealControl Server Pro до версії {} чи новіше!"),
        ...
        ("selinux_tip", "SELinux увімкнено на вашому пристрої, що може ускладнити для іншої сторони віддалене керування за допомогою RealControl."),
        ...
        ("allow-only-conn-window-open-tip", "Дозволяти підключення лише коли відкрите вікно RealControl"),
        ...
        ("About RealControl", "Про Rustdesk"),
