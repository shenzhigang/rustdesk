...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Ansluter till RealControl..."),
        ...
        ("install_tip", "På grund av UAC, kan inte RealControl fungera ordentligt på klientsidan. För att undvika problem med UAC, tryck på knappen nedan för att installera RealControl på systemet."),
        ...
        ("config_acc", "För att kontrollera din dator på distans måste du ge RealControl \"Tillgänglighets\" rättigheter."),
        ("config_screen", "För att kontrollera din dator på distans måste du ge RealControl \"Skärminspelnings\" rättigheter."),
        ...
        ("android_input_permission_tip2", "Gå till systeminställningarna, hitta [Installed Services], sätt på [RealControl Input] tjänsten."),
        ...
        ("Turned off", "Avstängd"),
        ("Language", "Språk"),
        ("Keep RealControl background service", "Behåll RealControl i bakgrunden"),
        ("Ignore Battery Optimizations", "Ignorera batterioptimering"),
        ("android_open_battery_optimizations_tip", "Om du vill stänga av denna funktion, gå till nästa RealControl programs inställningar, hitta [Batteri], Checka ur [Obegränsad]"),
        ("Start on boot", ""),
        ...
        ("Show RealControl", "Visa RealControl"),
        ("This PC", "Denna dator"),
        ("or", "eller"),
