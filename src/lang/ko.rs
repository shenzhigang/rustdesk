...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "준비"),
        ("Established", "연결됨"),
        ("connecting_status", "RealControl 네트워크로 연결중입니다..."),
        ...
        ("android_input_permission_tip2", "시스템 설정 페이지로 이동하여 [설치된 서비스]에서 [RealControl Input] 서비스를 켜십시오."),
        ...
        ("Turned off", "종료됨"),
        ("Language", "언어"),
        ("Keep RealControl background service", "RealControl 백그라운드 서비스로 유지하기"),
        ("Ignore Battery Optimizations", "배터리 최적화 무시하기"),
        ("android_open_battery_optimizations_tip", "해당 기능을 비활성화하려면 RealControl 응용 프로그램 설정 페이지로 이동하여 [배터리]에서 [제한 없음] 선택을 해제하십시오."),
        ...
        ("Show RealControl", "RealControl 표시"),
        ("This PC", "이 PC"),
        ("or", "또는"),
        ("Continue with", "계속"),
        ("Elevate", "권한 상승"),
        ...
        ("verify_rustdesk_password_tip", "RealControl 비밀번호 확인"),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "RealControl Server Pro를 {} 버전 이상으로 업그레이드하십시오!"),
        ...
        ("allow-only-conn-window-open-tip", "RealControl 창이 열려 있는 경우에만 연결을 허용하십시오."),
        ...
        ("floating_window_tip", "RealControl 백그라운드 서비스를 유지하는 것이 좋습니다."),
        ...
        ("About RealControl", "RealControl 대하여"),
