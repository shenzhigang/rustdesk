...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Menghubungkan ke jaringan RealControl..."),
        ...
        ("install_tip", "Karena UAC, RealControl tidak dapat bekerja dengan baik sebagai sisi remote dalam beberapa kasus. Untuk menghindari UAC, silakan klik tombol di bawah ini untuk menginstal RealControl ke sistem."),
        ("Click to upgrade", "Klik untuk upgrade"),
        ("Click to download", "Klik untuk unduh"),
        ("Click to update", "Klik untuk memperbarui"),
        ("Configure", "Konfigurasi"),
        ("config_acc", "Untuk mengontrol Desktop Anda dari jarak jauh, Anda perlu memberikan izin \"Aksesibilitas\" RealControl."),
        ("config_screen", "Untuk mengakses Desktop Anda dari jarak jauh, Anda perlu memberikan izin \"Perekaman Layar\" RealControl."),
        ...
        ("android_input_permission_tip1", "Agar perangkat jarak jauh dapat mengontrol perangkat Android Anda melalui mouse atau sentuhan, Anda harus mengizinkan RealControl untuk menggunakan layanan \"Aksesibilitas\"."),
        ("android_input_permission_tip2", "Silakan buka halaman pengaturan sistem berikutnya, temukan dan masuk ke [Layanan Terinstal], aktifkan layanan [Input RealControl]."),
        ...
        ("Language", "Bahasa"),
        ("Keep RealControl background service", "Pertahankan RealControl berjalan pada service background"),
        ...
        ("Show RealControl", "Tampilkan RealControl"),
        ("This PC", "PC ini"),
        ("or", "atau"),
        ...
        ("config_input", "Untuk menggunakan input keyboard remote, anda perlu memberikan izin \"Pemantauan Input\" pada RealControl"),
        ("config_microphone", "Untuk berbicara secara remote, anda perlu memberikan izin \"Rekam Audio\" pada RealControl"),
        ...
        ("still_click_uac_tip", "Masih memerlukan persetujuan pihak pengguna remote untuk mengklik OK pada jendela UAC RealControl yang sedang berjalan"),
        ...
        ("verify_rustdesk_password_tip", "Verifikasi Kata Sandi RealControl"),
        ...
        ("scam_text1", "Jika anda sedang berbicara di telepon dengan seseorang yang TIDAK dikenal dan mereka meminta anda untuk menggunakan RealControl, jangan lanjutkan dan segera tutup panggilan."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Silahkan perbarui RealControl Server Pro ke versi {} atau yang lebih baru!"),
        ...
        ("selinux_tip", "pada perangkat anda, SELinux sedang aktif, yang mana itu dapat mencegah RealControl berfungsi dengan baik sebagai sisi yang dikontrol."),
