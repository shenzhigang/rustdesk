...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Spajanje na RealControl mrežu..."),
        ...
        ("install_tip", "Zbog UAC-a RealControl ne može u nekim slučajevima raditi pravilno. Da biste prevazišli UAC, kliknite na tipku ispod da instalirate RealControl na sustav."),
        ...
        ("config_acc", "Da biste daljinski kontrolirali radnu površinu, RealControl-u trebate dodijeliti prava za \"Pristupačnost\"."),
        ("config_screen", "Da biste daljinski pristupili radnoj površini, RealControl-u trebate dodijeliti prava za \"Snimanje zaslona\"."),
        ...
        ("android_input_permission_tip1", "Da bi ste daljinski uređaj kontrolirali vašim Android uređajem preko miša ili na dodir, trebate dopustiti RealControl-u da koristi servis \"Pristupačnost\"."),
        ("android_input_permission_tip2", "Molimo prijeđite na sljedeću stranicu podešavanja sustava, pronađite i unesite [Instalirani servisi], uključite servis [RealControl Input]."),
        ...
        ("Language", "Jezik"),
        ("Keep RealControl background service", "Zadrži RealControl kao pozadinski servis"),
        ("Ignore Battery Optimizations", "Zanemari optimizaciju baterije"),
        ("android_open_battery_optimizations_tip", "Ako želite onemogućiti ovu funkciju, molimo idite na sljedeću stranicu za podešavanje RealControl aplikacije, pronađite i uđite u [Baterija], onemogućite [Neograničeno]"),
        ...
        ("Show RealControl", "Prikaži RealControl"),
        ...
        ("verify_rustdesk_password_tip", "Provjera lozinke za RealControl"),
        ...
        ("scam_text1", "Ako razgovarate telefonom s nekim koga NE POZNAJETE i NE VJERUJETE tko vas je zamolio da koristite i pokrenete RealControl, nemojte nastavljati razgovor i odmah spustite slušalicu."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Ažurirajte RealControl Server Pro na verziju {} ili noviju!"),
        ...
        ("selinux_tip", "Na vašem uređaju je omogućen SELinux, što može spriječiti RealControl da pravilno radi kao upravljana strana."),
        ...
        ("powered_by_me", "Pokreće RealControl"),
