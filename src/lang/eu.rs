...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "RealControl sarera konektatzen..."),
        ...
        ("install_tip", "Erabiltzaile Kontuen Kontrolarengatik, RealControl ezin du ondo funtzionatu urruneko mahaigainean. EKK saihesteko, mesedez, egin klik azpiko botoian RealControl sistema mailan instalatzeko."),
        ...
        ("config_acc", "Zure mahaigaina urrunetik kontrolatzeko, RealControl-i \"Irisgarritasuna\" baimenak eman behar dituzu."),
        ("config_screen", "Zure mahaigaina kanpotik kontrolatzeko, RealControl-i \"Pantaila grabatu\" baimena eman behar duzu."),
        ...
        ("android_input_permission_tip1", "Urruneko gailu batek zure Android gailua saguaren edo ukipenaren bidez kontrolatzeko, RealControl \"Irisgarritasuna\" zerbitzua erabiltzeko baimena eman behar diozu."),
        ("android_input_permission_tip2", "Joan hurrengo irekiko den sistemaren konfigurazio orrira, bilatu eta sartu [Instalatutako zerbitzuak], aktibatu [RealControl Input] zerbitzua."),
        ...
        ("Turned off", "Itzalita"),
        ("Language", "Hizkuntza"),
        ("Keep RealControl background service", "Mantendu RealControl atzeko planoko zerbitzu bezala"),
        ("Ignore Battery Optimizations", "Ezikusi bateria optimizazioak"),
        ("android_open_battery_optimizations_tip", "Ezaugarri hau desgaitu nahi baduzu, joan zaitez RealControl aplikazioaren ezarpen orrira, bilatu eta saltu [Bateria] orrira eta kendu [Mugarik gabe]"),
        ...
        ("Show RealControl", "Erakutsi RealControl"),
        ("This PC", "PC hau"),
        ("or", "edo"),
        ...
        ("config_input", "Urruneko mahaigaina teklatuaren bidez kontrolatzeko, RealControl-i \"Sarrera monitorizazioa\" baimena eman behar diozu."),
        ...
        ("still_click_uac_tip", "Oraindik beharrezkoa da urruneko erabiltzaileak Ondo botoiari klik egitea exekutatzen ari den RealControl UAC leihoan"),
        ...
        ("verify_rustdesk_password_tip", "Berretsi RealControl pasahitza"),
        ...
        ("scam_text1", "Ezagutzen eta fidatzen EZ duzun norbaitekin telefonoz bazaude eta RealControl erabiltzeko eta zerbitzua abiarazteko eskatu badizute, ez ezazu egin eta eskegi berehala."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Mesedez, bertsio-berritu RealControl Server Pro {} bertsiora edo berriago batera!"),
        ...
        ("selinux_tip", "SELinux zure gailuan gaituta dago. Honek RealControl kontrolatutako alde gisa dagoenean behar bezala ez exekutatzea ekarri dezake."),
        ...
        ("powered_by_me", "RealControl-ek egina"),
        ...
        ("allow-only-conn-window-open-tip", "Baimendu konexioa RealControl leihoa irekita badago"),
        ...
        ("floating_window_tip", "RealControl atzeko planoko zerbitzua mantentzen laguntzen du"),
