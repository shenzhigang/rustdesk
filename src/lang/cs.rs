...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Připojování k RealControl síti..."),
        ...
        ("install_tip", "Kvůli řízení oprávnění v systému (UAC), RealControl v některých případech na protistraně nefunguje správně. Abyste se UAC vyhnuli, klikněte na níže uvedené tlačítko a nainstalujte tak RealControl do systému."),
        ("Click to upgrade", "Aktualizovat"),
        ("Click to download", "Stáhnout"),
        ("Click to update", "Aktualizovat"),
        ("Configure", "Nastavit"),
        ("config_acc", "Aby bylo možné na dálku ovládat vaši plochu, je třeba aplikaci RealControl udělit oprávnění pro \"Zpřístupnění pro hendikepované\"."),
        ("config_screen", "Aby bylo možné přistupovat k vaší ploše na dálku, je třeba aplikaci RealControl udělit oprávnění pro \"Nahrávání obsahu obrazovky\"."),
        ...
        ("android_input_permission_tip1", "Aby vzdálené zařízení mohlo ovládat vaše Android zařízení prostřednictví myši či dotyků, je třeba povolit, aby RealControl mohlo používat službu „Zpřístupnění hendikepovaným“."),
        ("android_input_permission_tip2", "Přejděte na následující stránku nastavení systému, najděte a přejděte do [Nainstalované služby] a zapněte službu [RealControl vstup]."),
        ...
        ("Turned off", "Vypnutý"),
        ("Language", "Jazyk"),
        ("Keep RealControl background service", "Zachovat službu RealControl na pozadí"),
        ("Ignore Battery Optimizations", "Ignorovat optimalizaci baterie"),
        ("android_open_battery_optimizations_tip", "Pokud chcete tuto funkci zakázat, přejděte na další stránku nastavení aplikace RealControl, najděte a zadejte [Baterie], zrušte zaškrtnutí [Neomezeno]."),
        ...
        ("Show RealControl", "Zobrazit RealControl"),
        ...
        ("config_input", "Chcete-li ovládat vzdálenou plochu pomocí klávesnice, musíte udělit oprávnění RealControl \"Sledování vstupu\"."),
        ("config_microphone", "Abyste mohli mluvit na dálku, musíte udělit oprávnění RealControl \"Nahrávat zvuk\"."),
        ...
        ("verify_rustdesk_password_tip", "Ověření hesla RealControl"),
        ...
        ("scam_text1", "Pokud telefonujete s někým, koho NEZNÁTE a komu NEDŮVĚŘUJETE a kdo vás požádal o použití služby RealControl a její spuštění, nepokračujte v hovoru a okamžitě zavěste."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Aktualizujte prosím RealControl Server Pro na verzi {} nebo novější!"),
        ...
        ("powered_by_me", "Poháněno společností RealControl"),
        ...
        ("allow-only-conn-window-open-tip", "Povolit připojení pouze v případě, že je otevřené okno RealControl"),
        ...
        ("floating_window_tip", "Pomáhá udržovat službu RealControl na pozadí"),
        ...
        ("About RealControl", "O RealControl"),
