...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Kasutajakonto kontrolli (UAC) tõttu ei saa RealControl mõnel juhul korralikult kaugjuhtimispoolena töötada. Kontrolli vältimiseks palun klõpsa alloleval nupul, et RealControl oma süsteemi paigaldada."),
        ("Click to upgrade", ""),
        ("Click to download", ""),
        ("Click to update", ""),
        ("Configure", ""),
        ...
        ("android_input_permission_tip2", "Palun mine järgmisele süsteemiseadete lehele, leia ja sisesta [Paigaldatud teenused], lülita teenus [RealControl Input] sisse."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Palun täienda RealControl Server Pro versioonile {} või uuem!"),
