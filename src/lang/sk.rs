...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Pripájam sa na RealControl server..."),
        ...
        ("install_tip", "V niektorých prípadoch RealControl nefunguje správne z dôvodu riadenia užívateľských oprávnení (UAC). Vyhnete sa tomu kliknutím na nižšie zobrazene tlačítko a nainštalovaním RuskDesk do systému."),
        ...
        ("Configure", "Nastaviť"),
        ("config_acc", "Aby bolo možné na diaľku ovládať vašu plochu, je potrebné aplikácii RealControl udeliť práva \"Dostupnosť\"."),
        ("config_screen", "Aby bolo možné na diaľku sledovať vašu obrazovku, je potrebné aplikácii RealControl udeliť práva \"Zachytávanie obsahu obrazovky\"."),
        ...
        ("android_input_permission_tip1", "Aby bolo možné na diaľku ovládať vašu plochu pomocou myši alebo dotykov, je potrebné aplikácii RealControl udeliť práva \"Dostupnosť\"."),
        ("android_input_permission_tip2", "Prejdite na stránku nastavení systému, nájdite a vstúpte do [Stiahnuté služby], zapnite [RealControl Input] službu."),
        ...
        ("Turned off", "Vypnutý"),
        ("Language", "Jazyk"),
        ("Keep RealControl background service", "Ponechať službu RealControl na pozadí"),
        ...
        ("Show RealControl", "Zobraziť RealControl"),
        ...
        ("config_input", "Ak chcete ovládať vzdialenú plochu pomocou klávesnice, musíte udeliť oprávnenie RealControl \"Sledovanie vstupu\"."),
        ...
        ("still_click_uac_tip", "Stále sa vyžaduje, aby vzdialený používateľ klikol na tlačidlo OK v okne UAC spusteného programu RealControl."),
        ...
        ("verify_rustdesk_password_tip", "Overenie hesla RealControl"),
        ...
        ("scam_text1", "Ak telefonujete s niekým, koho nepoznáte a komu nedôverujete a kto vás požiadal o použitie a spustenie aplikácie RealControl, nepokračujte v hovore a okamžite zaveste."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Aktualizujte RealControl Server Pro na verziu {} alebo novšiu!"),
        ...
        ("powered_by_me", "Poháňané aplikáciou RealControl"),
        ...
        ("allow-only-conn-window-open-tip", "Povoliť pripojenie iba vtedy, ak je otvorené okno aplikácie RealControl"),
        ...
        ("floating_window_tip", "Pomáha udržiavať službu RealControl na pozadí"),
