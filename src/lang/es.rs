...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conexión a la red RealControl en progreso..."),
        ...
        ("install_tip", "Debido al Control de cuentas de usuario, es posible que RealControl no funcione correctamente como escritorio remoto. Para evitar este problema, haga clic en el botón de abajo para instalar RealControl a nivel de sistema."),
        ("Click to upgrade", "Clic para actualizar"),
        ("Click to download", "Clic para descargar"),
        ("Click to update", "Clic para refrescar"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar su escritorio desde el exterior, debe otorgar permiso a RealControl de \"Accesibilidad\"."),
        ("config_screen", "Para controlar su escritorio desde el exterior, debe otorgar permiso a RealControl de \"Grabación de pantalla\"."),
        ...
        ("android_input_permission_tip1", "Para que un dispositivo remoto controle su dispositivo Android a través del ratón o toque, debe permitir que RealControl use el servicio de \"Accesibilidad\"."),
        ("android_input_permission_tip2", "Vaya a la página de configuración del sistema que se abrirá a continuación, busque y acceda a [Servicios instalados], active el servicio [RealControl Input]."),
        ...
        ("Turned off", "Apagado"),
        ("Language", "Idioma"),
        ("Keep RealControl background service", "Dejar RealControl como Servicio en 2do plano"),
        ...
        ("Show RealControl", "Mostrar RealControl"),
        ("This PC", "Este PC"),
        ("or", "o"),
        ...
        ("config_input", "Para controlar el escritorio remoto con el teclado necesitas dar a RealControl permisos de \"Monitorización de entrada\"."),
        ("config_microphone", "Para poder hablar de forma remota necesitas darle a RealControl permisos de \"Grabar Audio\"."),
        ...
        ("verify_rustdesk_password_tip", "Verificar la contraseña de RealControl"),
        ...
        ("scam_text1", "Si estás al teléfono con alguien a quien NO conoces y en quien NO confías y te ha pedido que uses RealControl e inicies el servicio, no lo hagas y cuelga inmediatamente."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "¡Por favor, actualiza RealControl Server Pro a la versión {} o superior"),
        ...
        ("selinux_tip", "SELinux está activado en tu dispositivo, lo que puede hacer que RealControl no se ejecute correctamente como lado controlado."),
        ...
        ("powered_by_me", "Con tecnología de RealControl"),
        ...
        ("floating_window_tip", "Ayuda a mantener el servicio de RealControl de fondo"),
