...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Kullanıcı Hesabı Denetimi nedeniyle, RealControl bir uzak masaüstü olarak düzgün çalışmayabilir. Bu sorunu önlemek için, RealControl'i sistem seviyesinde kurmak için aşağıdaki butona tıklayın."),
        ...
        ("Configure", "Ayarla"),
        ("config_acc", "Masaüstünüzü dışarıdan kontrol etmek için RealControl'e \"Erişilebilirlik\""),
        ("config_screen", "Masaüstünüzü dışarıdan kontrol etmek için RealControl'e \"Ekran Kaydı\" iznini vermeniz gerekir."),
        ...
        ("android_input_permission_tip1", "Uzak bir cihazın Android cihazınızı fare veya dokunma yoluyla kontrol edebilmesi için, RealControl'in \"Erişilebilirlik\" özelliğini kullanmasına izin vermelisiniz."),
        ("android_input_permission_tip2", "Sonraki sistem ayarları sayfasına gidin, [Yüklü Hizmetler]'i bulun ve erişin, [RealControl Girişi] hizmetini etkinleştirin."),
        ...
        ("Language", "Dil"),
        ("Keep RealControl background service", "RealControl arka plan hizmetini sürdürün"),
        ...
        ("Show RealControl", "RealControl'i Göster"),
        ("This PC", "Bu PC"),
        ("or", "veya"),
        ...
        ("config_input", "Uzaktaki masaüstünü klavye ile kontrol etmek için RealControl'e \"Giriş İzleme\" izinleri vermelisiniz."),
        ("config_microphone", "Uzaktan konuşmak için RealControl'e \"Ses Kaydı\" izinleri vermelisiniz."),
        ...
        ("still_click_uac_tip", "Uzaktaki kullanıcının çalışan RealControl'in UAC penceresinde hala Tamam'ı tıklaması gerekmektedir."),
        ...
        ("verify_rustdesk_password_tip", "RealControl parolasını doğrulayın"),
