...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "جاري الاتصال بشبكة RealControl..."),
        ...
        ("install_tip", "بسبب صلاحيات تحكم حساب المستخدم. RealControl قد لا يعمل بشكل صحيح في جهة البعيد في بعض الحالات. لتفادي ذلك. الرجاء الضغط على الزر ادناه لتثبيت RealControl في جهازك."),
        ("Click to upgrade", "اضغط للارتقاء"),
        ("Click to download", "اضغط للتنزيل"),
        ("Click to update", "ضغط للتحديث"),
        ("Configure", "تهيئة"),
        ("config_acc", "لتتمكن من التحكم بسطح مكتبك البعيد, تحتاج الى منح RealControl اذونات \"امكانية الوصول\"."),
        ("config_screen", "لتتمكن من الوصول الى سطح مكتبك البعيد, تحتاج الى منح RealControl اذونات \"تسجيل الشاشة\"."),
        ...
        ("android_input_permission_tip1", "لكي يتمكن جهاز بعيد من التحكم بجهازك الـ Android عن طريق الفارة أو اللمس، يلزمك السماح لـ RealControl باستخدام خدمة \"إمكانية الوصول\"."),
        ("android_input_permission_tip2", "يرجى الانتقال إلى صفحة إعدادات النظام التالية، والعثور على [الخدمات المثبتة]، وتشغيل خدمة [RealControl Input]."),
        ...
        ("Turned off", "مطفئ"),
        ("Language", "اللغة"),
        ("Keep RealControl background service", "ابق خدمة RealControl تعمل في الخلفية"),
        ("Ignore Battery Optimizations", "تجاهل تحسينات البطارية"),
        ("android_open_battery_optimizations_tip", "اذا اردت تعطيل هذه الميزة, الرجاء الذهاب الى صفحة اعدادات تطبيق RealControl, ابحث عن البطارية, الغ تحديد غير مقيد"),
        ...
        ("Show RealControl", "عرض RealControl"),
        ("This PC", "هذا الحاسب"),
        ("or", "او"),
        ...
        ("config_input", "لتتمكن من التحكم بسطح المكتب البعيد. يجب من RealControl اذونات \"مراقبة المدخلات\"."),
        ("config_microphone", "لتتمكن من التحدث. يجب منح RealControl اذونات \"تسجيل الصوت\"."),
        ...
        ("still_click_uac_tip", "لازال يحتاج المستخدم البعيد للضغط على موافق في نافذة تحكم حساب المستخدم في RealControl الذي يعمل."),
        ...
        ("verify_rustdesk_password_tip", "تحقق من كلمة مرور RealControl"),
