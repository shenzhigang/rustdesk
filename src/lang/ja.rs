...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("android_input_permission_tip2", "次の端末設定ページに進み、「インストール済みアプリ」から「RealControl Input」を有効にしてください。"),
        ...
        ("Turned off", "オフになりました"),
        ("Language", "言語"),
        ("Keep RealControl background service", "RealControl バックグラウンドサービスを維持"),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "RealControl Server Proをバージョン{}以上にアップグレードしてください！"),
        ...
        ("About RealControl", "RustDeskについて"),
