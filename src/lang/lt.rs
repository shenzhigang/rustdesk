...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Prisijungiama prie RealControl tinklo..."),
        ...
        ("install_tip", "Kai kuriais atvejais UAC gali priversti RealControl netinkamai veikti nuotoliniame pagrindiniame kompiuteryje. Norėdami apeiti UAC, spustelėkite toliau esantį mygtuką, kad įdiegtumėte RealControl į savo kompiuterį."),
        ...
        ("config_acc", "Norėdami nuotoliniu būdu valdyti darbalaukį, turite suteikti RealControl \"prieigos\" leidimus"),
        ("config_screen", "Norėdami nuotoliniu būdu pasiekti darbalaukį, turite suteikti RealControl leidimus \"ekrano kopija\""),
        ("Installing ...", "Diegiama ..."),
        ("Install", "Diegti"),
        ...
        ("install_daemon_tip", "Norėdami, kad RealControl startuotų automatiškai, turite ją įdiegti"),
        ...
        ("android_input_permission_tip1", "Kad nuotolinis įrenginys galėtų valdyti Android įrenginį pele arba liesti, turite leisti RealControl naudoti \"Prieinamumo\" paslaugą."),
        ("android_input_permission_tip2", "Eikite į kitą sistemos nustatymų puslapį, suraskite \"Įdiegtos paslaugos\" ir įgalinkite \"RealControl įvestis\" paslaugą."),
        ...
        ("Turned off", "Išjungti"),
        ("Language", "Kalba"),
        ("Keep RealControl background service", "Palikti RealControl fonine paslauga"),
        ...
        ("Show RealControl", "Rodyti RealControl"),
        ...
        ("config_input", "Norėdami valdyti nuotolinį darbalaukį naudodami klaviatūrą, turite suteikti RealControl leidimus \"Įvesties monitoringas\"."),
        ("config_microphone", "Norėdami kalbėtis su nuotoline puse, turite suteikti RealControl leidimą \"Įrašyti garsą\"."),
        ...
        ("still_click_uac_tip", "Vis tiek reikia, kad nuotolinis vartotojas paleidžiant RealControl UAC lange paspaustų \"OK\"."),
        ...
        ("verify_rustdesk_password_tip", "Įveskite kliento RealControl slaptažodį"),
