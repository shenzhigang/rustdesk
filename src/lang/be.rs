...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Падключэнне да сеткі RealControl..."),
        ...
        ("install_tip", "У некаторых выпадках RealControl можа працаваць няправільна на аддаленым вузле з-за UAC. Каб пазбегнуць магчымых праблем з UAC, націсніце кнопку ніжэй для ўстаноўкі RealControl у сістэме."),
        ("Click to upgrade", "Абнавіць"),
        ("Click to download", "Спампаваць"),
        ("Click to update", "Абнавіць"),
        ("Configure", "Наладзіць"),
        ("config_acc", "Каб аддаленна кіраваць сваім працоўным сталом, вам неабходна дазволіць RealControl правы доступу."),
        ("config_screen", "Для аддаленага доступу да працоўнага сталу вам неабходна дазволіць RealControl правы здымку экрана."),
        ...
        ("android_input_permission_tip1", "Каб аддалёная прылада магла кіраваць вашай Android-прыладай з дапамогай мышы або націсканняў, неабходна дазволіць RealControl выкарыстоўваць паслугу \"Асаблівыя магчымасці\"."),
        ("android_input_permission_tip2", "Зайдзіце на адпаведную старонку сістэмных налад, знайдзіце і ўступіце ў \"Устаноўленыя паслугі\", уключыце паслугу \"RealControl Input\"."),
        ...
        ("Language", "Мова"),
        ("Keep RealControl background service", "Захаваць фонавую службу RealControl"),
        ...
        ("Show RealControl", "Паказаць RealControl"),
        ...
        ("config_input", "Каб кіраваць аддаленым працоўным сталом праз клавіятуру, неабходна дазволіць RealControl маніторынг уводу."),
        ("config_microphone", "Каб размаўляць з аддаленай старонкай, неабходна дазволіць RealControl запіс аўдыё."),
        ...
        ("still_click_uac_tip", "Дагэтуль патрэбна, каб аддалены карыстальнік націснуў \"OK\" ў акне UAC пры запуску RealControl."),
        ...
        ("verify_rustdesk_password_tip", "Пацвердзіць пароль RealControl"),
        ...
        ("scam_text1", "Калі вы размаўляеце па тэлефоне з кімсці, каго вы НЕ ВЕДАЕЦЕ і каму НЕ ДАВЕРАЕЦЕ, і ён просіць вас выкарыстаць RealControl і запусціць яго службу, не працягвайце і неадкладна адмяніце размову."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Абнавіце RealControl Server Pro да версіі {} або новейшай!"),
        ...
        ("selinux_tip", "На вашай прыладзе ўключаны SELinux, што можа перашкаджаць правільнай працы RealControl на кіруючым баку."),
        ...
        ("powered_by_me", "На аснове RealControl"),
        ...
        ("allow-only-conn-window-open-tip", "Дазволіць толькі падключэнне пры адкрытым акне RealControl"),
        ...
        ("floating_window_tip", "Дапамагае падтрымліваць фонавую службу RealControl"),
