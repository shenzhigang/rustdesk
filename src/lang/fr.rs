...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "Prêt"),
        ("Established", "Établi"),
        ("connecting_status", "Connexion au réseau RealControl..."),
        ...
        ("config_acc", "Afin de pouvoir contrôler votre bureau à distance, veuillez donner l'autorisation \"accessibilité\" à RealControl."),
        ("config_screen", "Afin de pouvoir accéder à votre bureau à distance, veuillez donner à RealControl l'autorisation \"enregistrement d'écran\"."),
        ...
        ("android_input_permission_tip1", "Pour qu'un appareil distant puisse contrôler votre appareil Android via la souris ou le toucher, vous devez autoriser RealControl à utiliser le service \"Accessibilité\"."),
        ("android_input_permission_tip2", "Veuillez accéder à la page suivante des paramètres système, recherchez et entrez [Services installés], activez le service [RealControl Input]."),
        ...
        ("Language", "Langue"),
        ("Keep RealControl background service", "Gardez le service RealControl en arrière plan"),
        ...
        ("Show RealControl", "Afficher RealControl"),
        ("This PC", "Ce PC"),
        ("or", "ou"),
        ...
        ("config_input", "Afin de contrôler le bureau à distance avec le clavier, vous devez accorder à RealControl l'autorisation \"Surveillance de l’entrée\"."),
        ("config_microphone", "Pour discuter à distance, vous devez accorder à RealControl les autorisations « Enregistrer l'audio »."),
        ...
        ("still_click_uac_tip", "Nécessite toujours que l'utilisateur distant confirme par la fenêtre UAC de RealControl en cours d'éxécution."),
        ...
        ("verify_rustdesk_password_tip", "Vérifier le mot de passe RealControl"),
        ...
        ("scam_text1", "Si vous êtes au téléphone avec quelqu'un QUE VOUS NE CONNAISSEZ PAS et en qui VOUS N'AVEZ PAS CONFIANCE et qui vous a demandé d'utiliser RealControl et de démarrer le service, ne le faites pas et raccrochez immédiatement."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Veuillez mettre à jour RealControl Server Pro avec la version {} ou une version plus récente !"),
        ...
        ("selinux_tip", "SELinux est activé sur votre appareil, ce qui peut empêcher RealControl de fonctionner correctement en tant que machine contrôlé."),
        ...
        ("allow-only-conn-window-open-tip", "N’autoriser la connexion que si la fenêtre RealControl est ouverte"),
