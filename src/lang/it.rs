...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connessione alla rete RealControl..."),
        ...
        ("install_tip", "A causa del Controllo Account Utente (UAC), RealControl potrebbe non funzionare correttamente come desktop remoto.\nPer evitare questo problema, fai clic sul tasto qui sotto per installare RealControl a livello di sistema."),
        ("Click to upgrade", "Aggiorna"),
        ("Click to download", "Download"),
        ("Click to update", "Aggiorna"),
        ("Configure", "Configura"),
        ("config_acc", "Per controllare il desktop dall'esterno, devi fornire a RealControl il permesso 'Accessibilità'."),
        ("config_screen", "Per controllare il desktop dall'esterno, devi fornire a RealControl il permesso 'Registrazione schermo'."),
        ...
        ("android_input_permission_tip1", "Affinché un dispositivo remoto possa controllare un dispositivo Android tramite mouse o tocco, devi consentire a RealControl di usare il servizio 'Accessibilità'."),
        ("android_input_permission_tip2", "Vai nella pagina delle impostazioni di sistema che si aprirà di seguito, trova e accedi a [Servizi installati], attiva il servizio [RealControl Input]."),
        ...
        ("Turned off", "Spegni"),
        ("Language", "Lingua"),
        ("Keep RealControl background service", "Mantieni il servizio di RealControl in background"),
        ("Ignore Battery Optimizations", "Ignora le ottimizzazioni della batteria"),
        ("android_open_battery_optimizations_tip", "Se vuoi disabilitare questa funzione, vai nelle impostazioni dell'applicazione RealControl, apri la sezione 'Batteria' e deseleziona 'Senza restrizioni'."),
        ...
        ("Show RealControl", "Visualizza RealControl"),
        ("This PC", "Questo PC"),
        ("or", "O"),
        ...
        ("config_input", "Per controllare il desktop remoto con la tastiera, è necessario concedere le autorizzazioni a RealControl 'Monitoraggio input'."),
        ("config_microphone", "Per poter chiamare, è necessario concedere l'autorizzazione 'Registra audio' a RealControl."),
        ...
        ("still_click_uac_tip", "Richiedi ancora che l'utente remoto selezioni 'OK' nella finestra UAC dell'esecuzione di RealControl."),
        ...
        ("verify_rustdesk_password_tip", "Conferma password RealControl"),
        ...
        ("Exit", "Esci da RealControl"),
        ("Open", "Apri RealControl"),
        ...
        ("scam_text1", "Se sei al telefono con qualcuno che NON conosci NON DI TUA FIDUCIA che ti ha chiesto di usare RealControl e di avviare il servizio, non procedere e riattacca subito."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Aggiorna RealControl Server Pro alla versione {} o successiva!"),
        ...
        ("selinux_tip", "In questo dispositivo è abilitato SELinux, che potrebbe impedire il corretto funzionamento di RealControl come lato controllato."),
        ...
        ("powered_by_me", "Alimentato da RealControl"),
        ...
        ("allow-only-conn-window-open-tip", "Consenti la connessione solo se la finestra RealControl è aperta"),
        ...
        ("floating_window_tip", "It helps to keep RealControl background service"),
        ...
        ("About RealControl", "Info su RealControl"),
