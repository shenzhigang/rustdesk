...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conectando à rede do RealControl..."),
        ...
        ("install_tip", "Devido ao UAC, o RealControl não funciona corretamente como o lado remoto em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o RealControl no sistema."),
        ...
        ("config_acc", "Para controlar seu computador remotamente, você precisa conceder ao RealControl permissões de \"Acessibilidade\"."),
        ("config_screen", "Para acessar seu computador remotamente, você precisa conceder ao RealControl permissões de \"Gravar a Tela\"/"),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle seu dispositivo Android via mouse ou toque, você precisa permitir que o RealControl use o serviço \"Acessibilidade\"."),
        ("android_input_permission_tip2", "Por favor vá para a próxima página de configuração do sistema, encontre e entre [Serviços Instalados], HABILITE o serviço [RealControl Input]."),
        ...
        ("Language", "Idioma"),
        ("Keep RealControl background service", "Manter o serviço do RealControl executando em segundo plano"),
        ...
        ("Show RealControl", "Exibir RealControl"),
        ...
        ("config_input", "Para controlar a área de trabalho remota com teclado, você precisa conceder a permissão \"Monitoramento de entrada\" do RealControl."),
        ("config_microphone", "Para falar remotamente, você precisa conceder a permissão \"Gravar áudio\" do RealControl."),
        ...
        ("still_click_uac_tip", "Ainda requer que o usuário remoto clique em OK na janela UAC da execução do RealControl."),
        ...
        ("verify_rustdesk_password_tip", "Verifique a senha do RealControl"),
