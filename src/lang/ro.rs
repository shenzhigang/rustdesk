...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "În curs de conectare la rețeaua RealControl..."),
        ...
        ("install_tip", "Din cauza restricțiilor CCU, este posibil ca RealControl să nu funcționeze corespunzător. Pentru a evita acest lucru, dă clic pe butonul de mai jos pentru a instala RealControl."),
        ...
        ("config_acc", "Pentru a controla desktopul la distanță, trebuie să permiți RealControl acces la setările de Accesibilitate."),
        ("config_screen", "Pentru a controla desktopul la distanță, trebuie să permiți RealControl acces la setările de Înregistrare ecran."),
        ...
        ("android_input_permission_tip1", "Pentru ca un dispozitiv la distanță să poată controla un dispozitiv Android folosind mouse-ul sau suportul tactil, trebuie să permiți RealControl să utilize serviciul „Accesibilitate”."),
        ("android_input_permission_tip2", "Accesează următoarea pagină din Setări, deschide [Aplicații instalate] și pornește serviciul [RealControl Input]."),
        ...
        ("Turned off", "Închis"),
        ("Language", "Limbă"),
        ("Keep RealControl background service", "Rulează serviciul RealControl în fundal"),
        ("Ignore Battery Optimizations", "Ignoră optimizările de baterie"),
        ("android_open_battery_optimizations_tip", "Pentru dezactivarea acestei funcții, accesează setările aplicației RealControl, deschide secțiunea [Baterie] și deselectează [Fără restricții]."),
        ...
        ("Show RealControl", "Afișează RealControl"),
        ("This PC", "Acest PC"),
        ("or", "sau"),
        ...
        ("config_input", "Pentru a controla desktopul la distanță folosind tastatura, trebuie să acorzi RealControl permisiunea Monitorizare intrare"),
        ("config_microphone", "Pentru a desfășura un apel vocal, este nevoie să acorzi RealControl permisiunea Înregistrare audio."),
        ...
        ("still_click_uac_tip", "Este necesar ca utilizatorul la distanță să confirme în fereastra CCU din RealControl care rulează."),
        ...
        ("verify_rustdesk_password_tip", "Verifică parola RealControl"),
