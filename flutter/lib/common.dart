...
Future<void> onActiveWindowChanged() async {
  ...
  if (rustDeskWinManager.getActiveWindows().isEmpty) {
    ...
    try {
      ...
      debugPrint("Start closing RealControl...");
...
Widget loadPowered(BuildContext context) {
  return MouseRegion(
    ...
    child: GestureDetector(
      onTap: () {
        launchUrl(Uri.parse('https://realcontrol.com'));
      },
      child: Opacity(
          opacity: 0.5,
          child: Text(
...
bool whitelistNotEmpty() {
  // https://realcontrol.com/docs/en/self-host/client-configuration/advanced-settings/#whitelist
