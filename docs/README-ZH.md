...
或者[自己设置](https://realcontrol.com/server)，
亦或者[开发您的版本](https://github.com/rustdesk/rustdesk-server-demo)。

![image](https://user-images.githubusercontent.com/71636191/171661982-430285f0-2e12-4b1d-9957-4a58e375304d.png)

RealControl 期待各位的贡献. 如何参与开发? 详情请看 [CONTRIBUTING.md](CONTRIBUTING.md).
...
## [构建](https://realcontrol.com/docs/en/dev/build/)
...
生成的可执行程序在 target 目录下，可直接通过指令运行调试 (Debug) 版本的 RealControl:
```sh
...
请注意：
* 请保证您运行的目录是在 RealControl 库的根目录内，否则软件会读不到文件。
