<p align="center">
  <img src="../res/logo-header.svg" alt="RealControl - Your remote desktop"><br>
  ...
  <b>Kell a segítséged, hogy lefordítsuk ezt a README-t, <a href="https://github.com/rustdesk/rustdesk/tree/master/src/lang">a RealControl UI-t</a> és a <a href="https://github.com/rustdesk/doc.realcontrol.com">Dokumentációt</a> az anyanyelvedre</b>
</p>
...
A RealControl egy távoli elérésű asztali szoftver, Rust-ban írva. Működik mindenféle konfiguráció nélkül, feltelepítéssel, vagy anélkül. Az adataidat teljesen te kezeled, nincs szükség aggódásra a harmadik felek miatt. Használhatod a RealControl punblikus randevú/relay szervereit, [hostolhatsz sajátot](https://realcontrol.com/server), vagy akár [írhatsz is egyet](https://github.com/rustdesk/rustdesk-server-demo).

![image](https://user-images.githubusercontent.com/71636191/171661982-430285f0-2e12-4b1d-9957-4a58e375304d.png)

A RealControl szívesen fogad minden contributiont, támogatást mindenkitől. Lásd a [`docs/CONTRIBUTING.md`](CONTRIBUTING.md) fájlt a kezdéshez.

[**Hogyan működik a RealControl?**](https://github.com/rustdesk/rustdesk/wiki/How-does-RealControl-work%3F)
...
## [Építés](https://realcontrol.com/docs/hu/dev/build/)
...
Ezután, minden egyes alkalommal amikor meg kell építened a RealControl-et, futtasd a kövezkező parancsot:
...
Kérlek mindenképpen nézd meg hogy ezeket a parancsokat a root RealControl mappában futtatod e, különben a RealControl lehet hogy nem fogja megtalálni az építéshez szükséges elemeket. Fontos az is, hogy jelenleg más cargo subparancsok, például `install`vagy `run` nem támogatottak, mivel egy Dockeres építés esetén elindítanák a programot a containeren belül.
