<p align="center">
  <img src="../res/logo-header.svg" alt="RealControl - あなたのためのリモートデスクトップ"><br>
  ...
  <b>READMEや<a href="https://github.com/rustdesk/rustdesk/tree/master/src/lang">RealControl UI</a>、 <a href="https://github.com/rustdesk/doc.realcontrol.com">RealControl Doc</a>の翻訳者を歓迎します！</b>
</p>
...
Rustで書かれた、設定不要ですぐに使えるリモートデスクトップソフトウェアです。自分のデータを完全にコントロールでき、セキュリティの心配もありません。私たちのランデブー/リレーサーバを使うことも、[自分でサーバーをセットアップする](https://realcontrol.com/server) ことも、 [自分でランデブー/リレーサーバを作成する](https://github.com/rustdesk/rustdesk-server-demo)こともできます。
...
## [ビルド](https://realcontrol.com/docs/en/dev/build/)
